...
// 配置元数据
export const romanticChristmasConfigMetadata = {
  ...
  tabs: [
    { id: 'scene' as const, label: '氛围' },
    { id: 'visual' as const, label: '装扮' },
    { id: 'content' as const, label: '心意' },
  ],
};
...
export default function RomanticChristmasPage() {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-sans text-white">
      ...
      {/* Configuration Panel Layer - Not included in the tool version since it's managed by the generic panel */}
    </div>
  );
}